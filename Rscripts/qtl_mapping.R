...
#phen_df = read.csv("~/harrislab/bxd_mutator_ms/csv/tidy_mutation_rates.csv")

# subset the dataframe to only include strains inbred for at least 
# 20 total generations
phen_df = subset(phen_df, n_inbreeding_gens >= 20)
...
covariate_cols = c("epoch", "n_intercross_gens", "is_ail")
