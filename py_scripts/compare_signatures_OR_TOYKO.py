...
muts_b = singleton_tidy[singleton_tidy["haplotype_at_qtl"] ==
                        "B"]["kmer"].values
muts_d = singleton_tidy[singleton_tidy["haplotype_at_qtl"] ==
                        "D"]["kmer"].values
...
base_muts = [
    '>'.join([m.split('>')[0][1], m.split('>')[1][1]]) for m in muts_b
]
...
ax.set_ylabel(
    'Fraction of de novo germline\nmutations in TOY-KO mice',
    fontsize=18,
)
ax.set_xlabel(
