...
def run(args):
    ...
    mutyh_vars = [
        "chr4:116814337-116814338",
        "chr4:116814394-116814394",
        "chr4:116815657-116815658",
        "chr4:116817415-116817416",
        "chr4:116817418-116817419",
        "chr4:116816475-116816476",
    ]

    var2samp = defaultdict(lambda:defaultdict())

    for site in mutyh_vars:
        vcf_hand = vcf(site)
        for v in vcf_hand:
            for alt_idx, alt in enumerate(v.ALT):
                ...
                for idx in idx2smp:
                    ...
                    if idx not in good_idxs:
                        var2samp[site][samp] = -1
                        continue
                    samp_gt = gts_reformatted[idx]
                    var2samp[site][samp] = samp_gt
    print (var2samp)
    ...
    for region_start in windows:
        ...
        region_ = "chr4:{}-{}".format(region_start, region_start + window_size)
        vcf_h = vcf(region_)
            ...
            for kmer_idx in np.arange(out_a.shape[1]):
                ...
                for site in var2samp:
                    ...
                    oo.append({
                        ...
                        "sample": samp_name,
                        "total": total,
                        "genotype": var2samp[site][samp_name],
                    })
