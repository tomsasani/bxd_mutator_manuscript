...
def reformat_genotypes(gts: np.array(int), alt_gt=1) -> np.array(int):
	"""
...
def normalize_var(ref: str, alt: str) -> (str, str):
	"""
...
def get_good_idxs(gts: np.array(int), 
				   gq: np.array(int), 
				   td: np.array(int), 
				   min_dp=10, 
				   min_gq=20) -> np.array(int):
	"""
