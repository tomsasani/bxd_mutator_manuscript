...
def run(args):
    ...
    for i, v in enumerate(vcf_h):
        ...
        for alt_idx, alt in enumerate(v.ALT):
            ...
            n_mice_with_var = np.sum((gts_reformatted[good_idxs] == 2)
                                     | (gts_reformatted[good_idxs] == 1))
